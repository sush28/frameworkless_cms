...
<body>
    ...
    <section class="container c-biografia">
        <div class="row c-grupo justify-content-center">
            <div class="col-md-12">
                <h2 class="titulo">Two Door Cinema Club</h2>
                <p>Two Door Cinema Club (a veces escrito "2 Door Cinema Club" o "TDCC") es una banda indie rock e indie pop de Irlanda del Norte y cuya formación se remonta a 2007. Alex y Sam se conocieron en los scouts, pero no permanecieron en contacto. Más tarde, se reencontraron en su colegio, donde conocieron a Kevin a través de una chica que ambos conocían. Antes de Two Door Cinema Club se llamaron Life Without Rory. Bajo este nombre participaron en el concurso de talentos ATL Rock School, tocando el tema "You Missed the Point". En MySpace se sigue conservando la página de dicha formación con sus otras dos canciones "Safe in Silence" y "Conscripted By Choice". </p>
            </div>
        </div>
